...

{
    ...
    public function execute()
    {
        ...
        $imageUploadId = $this->getRequest()->getParam('param_name', 'files');
        try {
            ...
            $basePath = $this->filesystem->getDirectoryRead(DirectoryList::MEDIA)->getAbsolutePath() . 'test/';
            ...
            $imageResult['url'] = $mediaUrl . 'test/' . $firstName . '/' . $secondName . '/'. $newImageName;
        } catch (\Exception $e) {
